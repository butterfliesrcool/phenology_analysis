...
length(battus_capped$julian_day)
butterfly_data <- rbind(battus_capped, astyanax_capped, archippus_capped)

#testing normality 
library("ggpubr")
# Density plot
ggdensity(butterfly_data$julian_day, fill = "lightgray")
# QQ plot
ggqqplot(butterfly_data$julian_day)
hist(butterfly_data$julian_day)
```
